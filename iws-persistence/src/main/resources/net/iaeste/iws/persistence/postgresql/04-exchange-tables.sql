...
create table student_applications (
    ...
    addressDuringTerms_id     integer,
    dateOfBirth               timestamp,
    university                varchar(1000),
    placeOfBirth              varchar(1000),
    completedYearsOfStudy     integer,
    totalYearsOfStudy         integer,
    lodgingByIaeste           integer,
    language_1                varchar(1000),
    language_1_level          varchar(1000),
    language_2                varchar(1000),
    language_2_level          varchar(1000),
    language_3                varchar(1000),
    language_3_level          varchar(1000),
    internshipStart           timestamp,
    internshipEnd             timestamp,
    study_fields              varchar(1000),
    specializations           varchar(1000),
    passportNumber            varchar(1000),
    passportPlaceOfIssue      varchar(1000),
    passportValidUntil        varchar(1000),
