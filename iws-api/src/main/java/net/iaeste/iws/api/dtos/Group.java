...
public final class Group extends AbstractVerification {
    ...
    /**
     * Sets the Group Id of the Group. The value is generated by the IWS, and if
     * it is set, the system will assume that it is the value to use. If the
     * value is not set, then the system will assume that the Group is a new
     * Group and treat it accordingly<br />
