...
public abstract class AbstractPaginatable extends AbstractVerification {
     ...
     * @see net.iaeste.iws.api.util.Paginatable#FIRST_PAGE
     */
     ...
     * @see net.iaeste.iws.api.util.Paginatable#MAX_PAGE_SIZE
     */
     ...
     *                           false
     * @see net.iaeste.iws.api.util.Paginatable#ASCENDING_SORT_ORDER
     */
