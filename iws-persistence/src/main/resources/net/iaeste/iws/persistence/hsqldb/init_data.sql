...
insert into grouptypes (id, grouptype) values (1, 'Country');
insert into grouptypes (id, grouptype) values (2, 'LC');
insert into grouptypes (id, grouptype) values (3, 'Asbl');
-- SID, IDT, GST...
insert into grouptypes (id, grouptype) values (4, 'Asbl Departments');

insert into roles (id, role) values ( 1, 'National Secretary');
insert into roles (id, role) values ( 2, 'NC Member');
insert into roles (id, role) values ( 3, 'NC Exchange');
insert into roles (id, role) values ( 4, 'LC Member');
insert into roles (id, role) values ( 5, 'LC Exchange Incoming');
insert into roles (id, role) values ( 6, 'LC Exchange Outgoing');
--No real use now, just for filling it up
insert into roles (id, role) values ( 7, 'LC President');
insert into roles (id, role) values ( 8, 'General Secretary');
insert into roles (id, role) values ( 9, 'IDT Coordinator');
insert into roles (id, role) values (10, 'IDT Member');
