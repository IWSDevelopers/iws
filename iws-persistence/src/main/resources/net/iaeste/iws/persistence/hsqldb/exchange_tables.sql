...
-- =============================================================================
create sequence offers_sequence start with 50 increment by 1;
create table offers (
...
create table offer_to_group (
    ...
    constraint offer_to_group_fk_student_id   foreign key (student_id) references students (id) ON DELETE SET NULL,
    constraint offer_to_group_fk_answered_by  foreign key (answered_by) references users (id) ON DELETE SET NULL,
