 ...
 * -----------------------------------------------------------------------------
 * Project: IntraWeb Services (iws-persistence) - net.iaeste.iws.persistence.UserNotificationDao
 * -----------------------------------------------------------------------------
 ...
 * @since 1.7
 */
public interface UserNotificationDao extends BasicDao {
    /**
     * Finds UserNotificationEntity (e.g. user's setting) for specified subject (i.e. event, offer, user, ...)
     *
    ...
    /**
     * Finds all NotificationMessageEntity for selected notification channel with specific status and processing date
     *
