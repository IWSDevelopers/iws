...
To build, please check out the sources and go to the iws-parent folder and there
run the Maven build command. IWS is a pure JEE7 Application, but there is only
configuration files created for WildFly, see iws-accessories).
