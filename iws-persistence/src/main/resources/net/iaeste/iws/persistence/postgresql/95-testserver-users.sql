...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('CO', 'Columbia', 'Columbia', 1960, 'FULL_MEMBER', 'COP');
...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('CH', 'Switzerland', 'Switzerland', 1960, 'FULL_MEMBER', 'CHF');
...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('FI', 'Finland', 'Finland', 1960, 'FULL_MEMBER', 'EUR');
...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('DE', 'Germany', 'Germany', 1960, 'FULL_MEMBER', 'EUR');
...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('AT', 'Austria', 'Austria', 1960, 'FULL_MEMBER', 'EUR');
...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('HR', 'Croatia', 'Croatia', 1960, 'FULL_MEMBER', 'HRK');
...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('JO', 'Jordan', 'Jordan', 1960, 'FULL_MEMBER', 'JOD');
...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('PL', 'Poland', 'Poland', 1960, 'FULL_MEMBER', 'PLN');
...
insert into countries (country_code, country_name, country_name_full, member_since, membership, currency) values ('NO', 'Norway', 'Norway', 1960, 'FULL_MEMBER', 'NOK');
