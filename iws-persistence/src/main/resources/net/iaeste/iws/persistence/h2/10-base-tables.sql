...
-- -----------------------------------------------------------------------------
-- Problems and causes:
-- When persisting an Object using IDENTITY for the ID Generation Type, it
-- seems that Hibernate is inserting a null in the query, resulting in a
-- ConstraintViolation Exception. More can be read here:
--   http://stackoverflow.com/questions/26123161/id-in-hibernate
--   https://en.wikibooks.org/wiki/Java_Persistence/Identity_and_Sequencing#Common_Problems_4
-- Problem is, that using SEQUENCE as generation type causes problems under
-- WildFly 10, and AUTO is also not working! Using TABLE, means that Hibernate
-- complains about a missing hibernate_sequence.
-- -----------------------------------------------------------------------------
-- Note; the use of H2 is currently highly experimental and many Unit tests
-- aren't correctly.
-- =============================================================================
...
create table versions (
    --id           integer default version_sequence.nextval,
...
create table countries (
    --id                  integer default country_sequence.nextval,
    id                  integer generated by default as identity,
    country_code        char(2),
...
create table groups (
    --id                  integer default group_sequence.nextval,
    id                  integer generated by default as identity,
...
create table aliases (
    --id                  integer default alias_sequence.nextval,
    id                  integer generated by default as identity,
    external_id         varchar(36),
    group_id            integer,
...
create table roles (
    --id                  integer default role_sequence.nextval,
    id                  integer generated by default as identity,
    external_id         varchar(36),
    role                varchar(50),
...
create table permission_to_role (
    --id                  integer default permission_to_role_sequence.nextval,
    id                  integer generated by default as identity,
    permission_id       integer,
    role_id             integer,
    created             timestamp default now(),
...
create table addresses (
    --id                  integer default address_sequence.nextval,
    id                  integer generated by default as identity,
...
create table persons (
    --id                 integer default person_sequence.nextval,
    id                 integer generated by default as identity,
...
-- names.
--   The EULA Version is the latest version of the End User License Agreement,
-- which the User have agreed to. Default is 0, as none has been accepted.
--   The UserType can be either Volunteer (default), Employed or Student, where
-- student is someone who is not involved with IAESTE. It is possible for all
-- users to also have a Student Object, thus allowing them to apply for Offers.
-- =============================================================================
create sequence user_sequence start with 1 increment by 1;
create table users (
    --id                  integer default user_sequence.nextval,
    id                  integer generated by default as identity,
    external_id         varchar(36),
...
-- makes a request.
--   The Session is having a deprecation timestamp, meaning a timestamp that is
-- set when the user either logged out, or where automatically logged out due to
-- a too long idle period or a server restart. If the deprecated timestamp is
-- null, then the user is logged in, otherwise not. The constraint is added to
-- verify this.
-- =============================================================================
create sequence session_sequence start with 1 increment by 1;
create table sessions (
    --id                  integer default session_sequence.nextval,
    id                  integer generated by default as identity,
    session_key         varchar(128),
    user_id             integer,
    deprecated          varchar(32) default '0',
    session_data        longvarbinary,
    modified            timestamp default now(),
    created             timestamp default now(),
...
create table requests (
    --id                integer default request_sequence.nextval,
    id                integer generated by default as identity,
    session_id        integer,
    request           varchar(100),
    errorcode         integer,
    errormessage      varchar(512),
    request_object    longvarbinary,
    created           timestamp default now(),
...
create table user_to_group (
    --id                     integer default user_to_group_sequence.nextval,
    id                     integer generated by default as identity,
    external_id            varchar(36),
    user_id                integer,
    group_id               integer,
...
create table history (
    --id                  integer default history_sequence.nextval,
    id                  integer generated by default as identity,
    user_id             integer,
    group_id            integer,
    tablename           varchar(50),
    record_id           integer,
    fields              longvarbinary,
    created             timestamp default now(),
...
-- -----------------------------------------------------------------------------
-- =============================================================================
create sequence folder_sequence start with 10 increment by 1;
create table folders (
    --id               integer default folder_sequence.nextval,
    id               integer generated by default as identity,
    external_id      varchar(36),
    parent_id        integer,
    group_id         integer,
    ...
    constraint folder_notnull_foldername   check (foldername is not null),
...
-- raw file is valid.
-- =============================================================================
create sequence file_sequence start with 20 increment by 1;
create table files (
    --id               integer default file_sequence.nextval,
    id               integer generated by default as identity,
    external_id      varchar(36),
    privacy          varchar(10) default 'PROTECTED',
    group_id         integer,
...
-- =============================================================================
create sequence filedata_sequence start with 1 increment by 1;
create table filedata (
    --id               integer default filedata_sequence.nextval,
    id               integer generated by default as identity,
    file_id          integer,
...
-- =============================================================================
create sequence attachment_sequence start with 1 increment by 1;
create table attachments (
    --id                  integer default attachment_sequence.nextval,
    id                  integer generated by default as identity,
...
create table mailing_lists (
    --id              integer default mailing_list_sequence.nextval,
    id                  integer generated by default as identity,
...
create table user_to_mailing_list (
    --id                integer default user_to_mailing_list_sequence.nextval,
    id                  integer generated by default as identity,
...
create table user_notifications (
    --id                 integer default user_notification_sequence.nextval,
    id                  integer generated by default as identity,
...
create table notification_messages (
    --id                 integer default notification_message_sequence.nextval,
    id                  integer generated by default as identity,
    user_id            integer,
    title              varchar(100),
...
create table notification_consumers (
    --id                 integer default notification_consumer_sequence.nextval,
    id                  integer generated by default as identity,
    group_id           integer,
    name               varchar(100),
...
-- =============================================================================
-- Notification Jobs - notification jobs to be processed by NotificationManager
-- -----------------------------------------------------------------------------
--
-- =============================================================================
create sequence notification_job_sequence start with 1 increment by 1;
create table notification_jobs (
    --id                  integer default notification_job_sequence.nextval,
    id                  integer generated by default as identity,
    notification_type   varchar(100),
...
create table notification_job_tasks (
    --id                  integer default notification_job_task_sequence.nextval,
    id                  integer generated by default as identity,
    job_id              integer,
    consumer_id         integer,
