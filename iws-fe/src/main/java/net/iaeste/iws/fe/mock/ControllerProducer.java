...
public class ControllerProducer {
    ...
    /**
     * This method is called each time {@link Exchange}
     * is injected into the system using @Inject,
     *
     * @return an implementation of the {@link Exchange} interfaces
     */
    @Produces
    @ApplicationScoped
    private Exchange getExchangeController() {
        LOG.trace("Creating instance of Exchange");
        return mock() ? mockExchangeController : exchangeController;
    }
