...
public final class CsvTransformer {
    ...
    public static Float toFloat(final Map<String, String> errors, final String field, final String input) {
        Float result = null;
    ...
    public static Integer toInteger(final Map<String, String> errors, final String field, final String input) {
        Integer result = null;
        if (input != null && !input.isEmpty()) {
            try {
    ...
    public static BigDecimal toBigDecimal(final Map<String, String> errors, final String field, final String input) {
    ...
    public static DatePeriod toDatePeriod(final Map<String, String> errors, final String field, final String inputFrom, final String inputTo) {
        DatePeriod result = null;
        final Date from = toDate(errors, field + " {From}", inputFrom);
        final Date to = toDate(errors, field + " {To}", inputTo);
    ...
    public static Date toDate(final Map<String, String> errors, final String field, final String input) {
        Date result = null;
        if (input != null && !input.isEmpty()) {
            try {
    ...
    public static Boolean toBoolean(final Map<String, String> errors, final String field, final String input) {
        Boolean result = null;
        if (input != null && !input.isEmpty()) {
    ...
    public static <T extends Enum<T>> T toEnum(final Map<String, String> errors, final String field, final String input, final Class<T> enumType) {
        T result = null;
        if (input != null && !input.isEmpty()) {
            try {
    ...
    public static Set<StudyLevel> toStudyLevels(final Map<String, String> errors, final String field, final String inputBeginning, final String inputMiddle, final String inputEnd) {
        ...
        if (levelBeginning) result.add(StudyLevel.B);
        if (levelMiddle) result.add(StudyLevel.M);
        if (levelEnd) result.add(StudyLevel.E);

        return result;
    }

    public static <T extends Enum<T>> Set<T> toEnumSet(final Map<String, String> errors, final String field, final String input, final Class<T> enumType) {
        Set<T> result = null;
        try {
    ...
    public static Set<String> toStringSet(final Map<String, String> errors, final String field, final String input) {
