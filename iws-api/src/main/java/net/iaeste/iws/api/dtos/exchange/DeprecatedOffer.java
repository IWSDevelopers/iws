...
/**
 * Deprecated IAESTE Offer - to be deleted!
 *
 ...
 */
@Deprecated
public final class DeprecatedOffer extends AbstractVerification {
...
//     */
//    public DeprecatedOffer(final DeprecatedOffer offer) {
//        if (offer != null) {
...
//        }
//
//        final DeprecatedOffer offer = (DeprecatedOffer) obj;
//
...
//    /**
//     * validations:
//     * <ul><li>number of selected specialization should be below limit, {@link net.iaeste.iws.api.constants.exchange.IWSExchangeConstants#MAX_OFFER_SPECIALIZATIONS}</li></ul>
//     *
