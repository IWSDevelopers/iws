...
create table grouptypes (
    id                 integer not null primary key,
    grouptype          varchar(50) unique not null,
    description        varchar(2048),
);
...
--   Note, custom roles are linked to a specific Country, and will be available for all subgroups in a Country. It is not permitted to create Custom Roles for
-- =============================================================================
...
-- Monitoring History
-- -----------------------------------------------------------------------------
-- Monitoring if changes is stored in this table. The changes include the user,
